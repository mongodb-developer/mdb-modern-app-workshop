...
Select your database and collection (database: `eventer` collection `events`), leave the index name set to `vector_index`, and add the following code in the JSON editor:
